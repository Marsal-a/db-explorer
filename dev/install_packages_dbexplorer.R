...
install.packages("shinyBS",lib=lib_to_install)
# install.packages("rclipboard",lib=lib_to_install)
# install.packages("duckdb",lib=lib_to_install)
# install.packages("arrow",lib=lib_to_install)
